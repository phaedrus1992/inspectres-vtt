...
Make sure you have InSpectres installed and Foundry running with an active world. See [Installation](../install/from-release.md) if you haven't set up yet.
...
See [Mechanics](./mechanics.md) for details on stress, recovery, and franchise operations.
...
- **Understand the full mechanics:** Read [Mechanics & Rules](./mechanics.md)
- **Troubleshoot issues:** Check [Troubleshooting](./troubleshooting.md)
