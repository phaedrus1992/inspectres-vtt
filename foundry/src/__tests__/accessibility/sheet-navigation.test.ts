...
describe("Sheet navigation and tab switching (E2E - Playwright)", () => {
  it("should test tab visibility and structure", () => {
  ...
  it("should test active tab indication", () => {
  ...
  it("should test tab switching behavior", () => {
  ...
  it("should test content visibility and accessibility", () => {
  ...
  it("should test tab accessibility attributes", () => {
